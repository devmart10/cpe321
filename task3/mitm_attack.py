...
def main():
	...
	# Mallory modifies the generator
	# g = 1
	# g = p
	# g = p - 1
	...
	# Mallory modifies the two base numbers and generates her own key
	A = p
	B = p
	k_Mallory = create_key(p, 1, p)
	...
	# Mallory also has the key
	assert k_Mallory == k_Alice
	...
	# Mallory can also read it
	m0_mallory = cbc_decrypt(m0_encrypted, k_Mallory, shared_iv)
	print("Mallory received:", m0_mallory)
	...
	# Mallory can also read it
	m1_mallory = cbc_decrypt(m1_encrypted, k_Mallory, shared_iv)
	print("Mallory received:", m1_mallory)
